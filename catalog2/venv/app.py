...
catalogIpAddress2="192.168.1.71"//thats me
...
def update(id):
   ...
   response  = requests.put("http://"+catalogIpAddress1+":5000/update_amount_consistancy/"+ str(id), {'amount':amount2})
...
def update_price(id):
    ...
    response = requests.put("http://"+catalogIpAddress1+":5000/update_price_consistancy/" + str(id), {'price': price})
